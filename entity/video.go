...
type Video struct {
	...
	CreatedAt   time.Time `json:"-" gorm:"default:(datetime('now','localtime'))" json:"created_at"`
	UpdatedAt   time.Time `json:"-" gorm:"default:(datetime('now','localtime'))" json:"updated_at"`
}
